...
<!-- The CI matrix is discovered from ue-cache/* releases at runtime, so there
     is no YAML list a dynamic badge can query anymore; update this by hand
     when the supported range in .github/workflows/engine-cache.yml changes -->
[![engine](https://img.shields.io/badge/engine-4.24%20--%205.8-black)](https://github.com/N7Alpha/UnrealLibretro/releases/latest)
[![mac engine](https://img.shields.io/badge/mac-5.8%20arm64-black)](https://github.com/N7Alpha/UnrealLibretro/releases/latest)
